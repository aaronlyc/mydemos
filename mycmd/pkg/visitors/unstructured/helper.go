...
func (s unstructuredJSONScheme) Decode(data []byte, obj *Unstructured) (*Unstructured, error) {
	var err error
	if obj != nil {
...
func (s unstructuredJSONScheme) Encode(obj *Unstructured, w io.Writer) error {
	return s.doEncode(obj, w)
}

func (unstructuredJSONScheme) doEncode(obj *Unstructured, w io.Writer) error {
	return json.NewEncoder(w).Encode(obj.Object)
}
...
func (s unstructuredJSONScheme) decode(data []byte) (*Unstructured, error) {
...
func (s unstructuredJSONScheme) decodeInto(data []byte, obj *Unstructured) error {

...
func (d *YAMLOrJSONDecoder) Decode(into interface{}) error {
	if d.decoder == nil {
		buffer, _ := BufferPeekStream(d.r, d.bufferSize)
...
// BufferPeekStream scans the provided reader up to size
// It will return the bufio.Reader it creates for the consumer.
func BufferPeekStream(r io.Reader, size int) (io.Reader, []byte) {

...
import (
	v1alpha1 "mydemos/sample-controller-manager/pkg/apis/samplecontroller/v1alpha1"
	"mydemos/sample-controller-manager/pkg/generated/clientset/versioned/scheme"
	"net/http"
...
// SamplecontrollerV1alpha1Client is used to interact with features provided by the samplecontroller.ctr.io group.

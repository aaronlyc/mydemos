...
import (
	"context"
	samplecontrollerv1alpha1 "mydemos/sample-controller-manager/pkg/apis/samplecontroller/v1alpha1"
	versioned "mydemos/sample-controller-manager/pkg/generated/clientset/versioned"
	internalinterfaces "mydemos/sample-controller-manager/pkg/generated/informers/externalversions/internalinterfaces"
	v1alpha1 "mydemos/sample-controller-manager/pkg/generated/listers/samplecontroller/v1alpha1"
	time "time"

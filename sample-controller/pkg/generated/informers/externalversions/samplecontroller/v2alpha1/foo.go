...
import (
	"context"
	samplecontrollerv2alpha1 "mydemos/sample-controller/pkg/apis/samplecontroller/v2alpha1"
	versioned "mydemos/sample-controller/pkg/generated/clientset/versioned"
	internalinterfaces "mydemos/sample-controller/pkg/generated/informers/externalversions/internalinterfaces"
	v2alpha1 "mydemos/sample-controller/pkg/generated/listers/samplecontroller/v2alpha1"
	time "time"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.SamplecontrollerV2alpha1().Foos(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.SamplecontrollerV2alpha1().Foos(namespace).Watch(context.TODO(), options)
			},
		},
		&samplecontrollerv2alpha1.Foo{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *fooInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&samplecontrollerv2alpha1.Foo{}, f.defaultInformer)
}

func (f *fooInformer) Lister() v2alpha1.FooLister {
	return v2alpha1.NewFooLister(f.Informer().GetIndexer())
}

...
**Note:** go-get or vendor this package as `mydemos/sample-controller`.
...
```sh
go get -d mydemos/sample-controller
cd $GOPATH/src/mydemos/sample-controller
godep restore
```
...
`kubernetes/staging/src/mydemos/sample-controller` and its dependencies
...
https://github.com/kubernetes/kubernetes/blob/master/staging/src/mydemos/sample-controller.
